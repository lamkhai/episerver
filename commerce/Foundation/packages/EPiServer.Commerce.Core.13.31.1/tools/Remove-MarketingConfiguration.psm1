...
Function Remove-MarketingConfiguration([System.Xml.XmlDocument]$config)
{
    ...
    if ($marketingModule) 
    {
        $marketingModule.ParentNode.RemoveChild($marketingModule)
    }
}
# SIG # Begin signature block
# MIIOLQYJKoZIhvcNAQcCoIIOHjCCDhoCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU0y9ScdRL+1mQCiWjm1TnVTPt
# qRqgggtkMIIFZzCCBE+gAwIBAgIRAJgvkmklxJsCm+Wj934zo1UwDQYJKoZIhvcN
...
# BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTzVx+GqUdlH7gQQHy6iz5eeIXnXTAN
# BgkqhkiG9w0BAQEFAASCAQCwgjOuR68WCENhOYWhiZIRp1h49vmMHAg27t70xnkt
# jFecP5NSjQPRFG098j/Qgrj9KC7868U4Na6U9FavHLAGsPRNoEQ8qDgFhEPL1Dz+
# ycSZ7hagQ4QQgRMGzjdnD9FHx0BWt+sj8KijTJJ1OtZbndjY1Fjb04FAm3hiMXhb
# 8KIEcHa1s3vwaI6Zr8rtNk34drWcg6tUbcYG4gc+CSoZlllC+NR8gmPgv3msMvgp
# mvOjXw1DHAERT/E4xaq+HZc4HQ1VwnjysWp/bPZqjpgtTQKkPIkknFc8ICz6PJ6g
# vFLygi4k5geizs00iTNyMFOx1Nt4VPckjMpPS4hzvzhR
