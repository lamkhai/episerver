...
$findCommerceConfigBaselinePath =[System.IO.Path]::Combine($installPath, "tools\webconfig-update.config")
...
else
{
    ...
    Write-Host "Updating Find Commerce configuration"
    & $deployEXEPath -s $sitePath -a config -p $findCommerceConfigBaselinePath
}

# SIG # Begin signature block
# MIIY1QYJKoZIhvcNAQcCoIIYxjCCGMICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUskzoyAPofpaoIhzF4IebnppF
# e8WgghP9MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# ARUwIwYJKoZIhvcNAQkEMRYEFBXVocycoXXrTOxiYaEfl1EpTThuMA0GCSqGSIb3
# DQEBAQUABIIBACaMl0FZYs5EPoipUMEHDIfIotDoenGhTTPbMiJYrJHpS4U+h+5m
# gnQaHeYSUFEBV6jOLW7jJ8xxlezP2y445KJAf/K10sjcOMVrf8ouDv97Oxs9gCDq
# 6rJ8FIld6GAbAfSoBMApQy8A4a1yjrL0hai3csEl2oZmFGmCTR4EfhVnyDQ7El/q
# vQO6L5eEWy1BVj6K6x84pZ29Y/6JAwEaIep2bnpZKuHEitJYRoJs5VDI2z6eMYvM
# D06DYkaF5mbPzSD88ZL5JhVp2U1qxlo+w1w8HsRLI1TyMkuWO6Av31AXsaTf7YxT
# z2Ae1iJFnAIe3S1VR+Yt9230bTI8IPOazwuhggILMIICBwYJKoZIhvcNAQkGMYIB
...
# hvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjAxMTE5MDM0MDU5
# WjAjBgkqhkiG9w0BCQQxFgQUuFBcerbFLIMjAJwQaBiww+ujbHgwDQYJKoZIhvcN
# AQEBBQAEggEAln0KSWst2gCgQceeB3yiDr7G6y1wEejL5RWZqBT66mwCKptOkKMh
# 1y0A0JDgI2j/vLehFTBqUtxgb+WaJb525Ocgh0OYVyA9bzpGL1Z4KYr/e2PpOR8m
# WbWNTvcFBpec5/f46BVu4VfwgEblJIzPZYT/bhYEEkQwehAbL8c4RgtVZ0j7k8Ak
# 1uG6Pcsic6EM1gwEvw8QrbjYLxrOWUnMu9nDDuHmXip70SBZMh0Lp/lDpdGhcQ2D
# P4C1EHqbnuB3fJfOdkwGlhT10tqKk866yCri6BmxdMOqp/xP9Ek69VTLlE6vhDEK
# mDdwuvhF8B7UUjgr8fCOWsjHKpZFsvbEww==
