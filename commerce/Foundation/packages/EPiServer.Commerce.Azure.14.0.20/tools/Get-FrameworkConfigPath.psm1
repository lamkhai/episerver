Function Get-FrameworkConfigPath($sitePath)
{
	$frameworkConfigPath = join-path $sitePath "EPiServerFramework.config"
	...
	{
		Write-Host "Unable to find a Framework configuration file."
		return
	}
	return $configPath
}

Export-ModuleMember -Function Get-FrameworkConfigPath
# SIG # Begin signature block
# MIIOLQYJKoZIhvcNAQcCoIIOHjCCDhoCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUId7IBbBvaOPtCDlR7cUWaNA2
# 0JCgggtkMIIFZzCCBE+gAwIBAgIRAJgvkmklxJsCm+Wj934zo1UwDQYJKoZIhvcN
...
# BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQF+v8zJ2wzDzU7sQ7OSgzqNpxjLDAN
# BgkqhkiG9w0BAQEFAASCAQCnhhja1O08hdwCmMbwiGQPr5tVZjAu9Cz5QQmUTuOB
# oLlV7EePLD7zP4xEtrIPeB0WlbfIAlBEbKKW+Vg2dWVh0Yhr5ghAj8/6RAOSoWGd
# W1j+LXb8WjCqwztI2gZseGeVA7jV2wiqh3r6P2PbGIGQrPTId38l2DM2yuHnh4ue
# wpkN6jXoanqdYyhUZ4UdDeoxmtSJr9jk8Fud6R6MomQzGb6XKT1Cnlu+1iAGCJI9
# AgFuIxcbrfheQCmvNtD5R8hTo9Kf2uAUSmBfpKK/jKK5US0AeFoD65lyfSQRCy5H
# x1f3mpd7BpewLEiT6bRH8irIHVao9S8Ps6LfdyoKv2xz
